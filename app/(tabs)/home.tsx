        ...
        cookingInstructions: [
          {
            ...
            three:
              "Toast the buns: Slice the burger buns and toast them lightly on the grill or in a toaster.",
        ...
        cookingInstructions: [
          {
            ...
            three:
              "Stir-fry the vegetables: Add the onion, bell pepper, and garlic to the pan. Stir-fry for 2-3 minutes until tender.",
        ...
        cookingInstructions: [
          {
            ...
            three:
              "Add sauces: Stir in soy sauce, oyster sauce, and chili sauce. Mix well.",
        ...
        cookingInstructions: [
          {
            ...
            three:
              "Make the omelet: Pour the egg mixture into the pan over the cooked vegetables. Let it cook for 2-3 minutes without stirring.",
        ...
        cookingInstructions: [
          {
            ...
            three:
              "Assemble the sushi: Place a sheet of nori on a bamboo mat. Spread a thin layer of rice over the nori, leaving a small border at the top.",
      ...
      <FlatList
        ...
        ListHeaderComponent={() => (
          <View className="mt-10">
            ...
            <SearchInput />
            <View className="mt-5">
              <Text className="text-center text-secondary-200 font-pbold">
                Hot Recipe's
              </Text>
            </View>
            ...
            <View className="mt-2">
              <Text className="text-2xl font-pregular">
                ...
                <Text className="text-pink-500 font-psemibold">
        ...
        ListEmptyComponent={() => (
          <EmptyState
            ...
            subtitles="Try Again ! New Recipe are coming soon"
          />
        )}
      />
    </SafeAreaView>
